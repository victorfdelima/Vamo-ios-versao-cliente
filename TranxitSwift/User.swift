...
class User : NSObject, NSCoding, JSONSerializable {
    ...
    required convenience init?(coder aDecoder: NSCoder) {
        ...
        let cpf = aDecoder.decodeObject(forKey: Keys.list.cpf) as? String
        ...
        self.init(id: id, accessToken : accessToken, firstName : firstName, lastName : lastName, cpf : cpf, mobile : mobile, country_code: country_code, email: email, currency : currency, picture : picture, refreshToken : refreshToken, walletBalance : walletBalance, sos : sos,loginType : loginType, dispatcherNumber : dispatcherNumber, isBrainTreeAllowed : isBrainTreeAllowed, isPayumoneyAllowed : isPayumoneyAllowed, isPaytmAllowed : isPaytmAllowed, isCardAllowed : isCardAllowed, isCashAllowed : isCashAllowed, measurement : measurement, stripeKey : stripeKey,referral_count:referral_count,referral_unique_id:referral_unique_id,referral_total_text:referral_total_text,referral_text:referral_text,otp:otp,ride_otp:ride_otp, qrcode_url: qrcode_url)
    ...
    func encode(with aCoder: NSCoder) {
        ...
        aCoder.encode(self.cpf, forKey: Keys.list.cpf)
