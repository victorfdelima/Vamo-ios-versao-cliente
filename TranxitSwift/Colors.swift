...
extension UIColor {
    ...
    static var primary : UIColor {
        return #colorLiteral(red: 0.1651219726, green: 0.03237840161, blue: 0.3548621535, alpha: 1) //UIColor(red: 149/255, green: 117/255, blue: 205/255, alpha: 1)
    }
    
    // Secondary Color
    static var secondary : UIColor {
        return #colorLiteral(red: 0.4651716352, green: 0.1649470925, blue: 0.5638080835, alpha: 1) //UIColor(red: 238/255, green: 98/255, blue: 145/255, alpha: 1)
    }
